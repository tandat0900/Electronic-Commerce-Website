...
export class UtilityService {
  ...
  calculatePayment(cart: Cart, payment: Payment) {
    ...
    if (payment.amountPaid > 20000000) payment.shipingCharges = 30000;
    else if (payment.amountPaid > 5000000) payment.shipingCharges = 20000;
    else if (payment.amountPaid > 2000000) payment.shipingCharges = 20000;
